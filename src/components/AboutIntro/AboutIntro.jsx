    ...
    <section className="container py-5">
      <div className="row align-items-center about-intro-section">
        ...
        <div className="col-lg-6" data-aos="fade-right">
          ...
          <h1 className="fw-bold mb-4" data-aos="fade-right" data-aos-delay="200">Krishnan Thiruvengadam</h1>

          <p className="text-muted lead" data-aos="fade-right" data-aos-delay="300">
          ...
          <p className="text-muted" data-aos="fade-right" data-aos-delay="500">
          ...
          <p className="text-muted" data-aos="fade-right" data-aos-delay="700">
        ...
        <div className="col-lg-6 text-center mt-4 mt-lg-0" data-aos="fade-left">
          <div className="about-visual-card">
            ...
            <div className="metric-block" data-aos="fade-left" data-aos-delay="200">
              <h3 className="text-primary fw-bold" >15+ Years</h3>
              <p>Enterprise Cloud Delivery</p>
            </div>

            <div className="metric-block" data-aos="fade-left" data-aos-delay="300">
              <h3 className="text-primary fw-bold" >6 Countries</h3>
              <p>Global Transformation Experience</p>
            </div>

            <div className="metric-block" data-aos="fade-left" data-aos-delay="500">
